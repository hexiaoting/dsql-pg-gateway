...
struct TImpalaQueryOptions {
  enum type {
    ...
    DISABLE_AGG_PUSHDOWN = 31,
    DISABLE_SORT_PUSHDOWN = 32,
    PG_BATCHSIZE = 33,
    NEW_TABLET = 34,
    PG_ENCODING = 35
  };
...
class TGetExecSummaryReq {
 public:
  ...
  static const char* ascii_fingerprint; // = "6D657EE32DDF2062A05D313A68812A2E";
  static const uint8_t binary_fingerprint[16]; // = {0x6D,0x65,0x7E,0xE3,0x2D,0xDF,0x20,0x62,0xA0,0x5D,0x31,0x3A,0x68,0x81,0x2A,0x2E};
...
class TGetExecSummaryResp {
 public:
  ...
  static const char* ascii_fingerprint; // = "4C17E0E3F087B74FDED759308B89D559";
  static const uint8_t binary_fingerprint[16]; // = {0x4C,0x17,0xE0,0xE3,0xF0,0x87,0xB7,0x4F,0xDE,0xD7,0x59,0x30,0x8B,0x89,0xD5,0x59};

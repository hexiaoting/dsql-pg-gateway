...
class ImpalaServiceIf : virtual public  ::beeswax::BeeswaxServiceIf {
 public:
  ...
  virtual void GetExecSummary( ::impala::TExecSummary& _return, const  ::beeswax::QueryHandle& handle) = 0;
};
...
typedef struct _ImpalaService_GetExecSummary_args__isset {
  _ImpalaService_GetExecSummary_args__isset() : handle(false) {}
  bool handle;
} _ImpalaService_GetExecSummary_args__isset;

class ImpalaService_GetExecSummary_args {
 public:

  ImpalaService_GetExecSummary_args() {
  }

  virtual ~ImpalaService_GetExecSummary_args() throw() {}

   ::beeswax::QueryHandle handle;

  _ImpalaService_GetExecSummary_args__isset __isset;
  ...
  bool operator == (const ImpalaService_GetExecSummary_args & rhs) const
  {
    if (!(handle == rhs.handle))
      return false;
    return true;
  ...
  bool operator < (const ImpalaService_GetExecSummary_args & ) const;
...
class ImpalaService_GetExecSummary_pargs {
 public:


  virtual ~ImpalaService_GetExecSummary_pargs() throw() {}
...
typedef struct _ImpalaService_GetExecSummary_result__isset {
  _ImpalaService_GetExecSummary_result__isset() : success(false), error(false), error2(false) {}
  bool success;
  bool error;
  bool error2;
} _ImpalaService_GetExecSummary_result__isset;
...
class ImpalaService_GetExecSummary_result {
 public:
  ...
  virtual ~ImpalaService_GetExecSummary_result() throw() {}

   ::impala::TExecSummary success;
   ::beeswax::QueryNotFoundException error;
   ::beeswax::BeeswaxException error2;

  _ImpalaService_GetExecSummary_result__isset __isset;

  void __set_success(const  ::impala::TExecSummary& val) {
    success = val;
    __isset.success = true;
  }
  ...
  bool operator == (const ImpalaService_GetExecSummary_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(error == rhs.error))
  ...
  bool operator < (const ImpalaService_GetExecSummary_result & ) const;
...
typedef struct _ImpalaService_GetExecSummary_presult__isset {
  _ImpalaService_GetExecSummary_presult__isset() : success(false), error(false), error2(false) {}
  bool success;
  bool error;
  bool error2;
} _ImpalaService_GetExecSummary_presult__isset;

class ImpalaService_GetExecSummary_presult {
 public:


  virtual ~ImpalaService_GetExecSummary_presult() throw() {}

   ::impala::TExecSummary* success;
   ::beeswax::QueryNotFoundException error;
   ::beeswax::BeeswaxException error2;

  _ImpalaService_GetExecSummary_presult__isset __isset;
...
class ImpalaServiceClient : virtual public ImpalaServiceIf, public  ::beeswax::BeeswaxServiceClient {
 public:
  ...
  void GetExecSummary( ::impala::TExecSummary& _return, const  ::beeswax::QueryHandle& handle);
  void send_GetExecSummary(const  ::beeswax::QueryHandle& handle);
  void recv_GetExecSummary( ::impala::TExecSummary& _return);
};
...
class ImpalaServiceProcessor : public  ::beeswax::BeeswaxServiceProcessor {
 ...
 public:
  ImpalaServiceProcessor(boost::shared_ptr<ImpalaServiceIf> iface) :
    ...
    processMap_["GetExecSummary"] = &ImpalaServiceProcessor::process_GetExecSummary;
  }
...
class ImpalaServiceMultiface : virtual public ImpalaServiceIf, public  ::beeswax::BeeswaxServiceMultiface {
 ...
 public:
  ...
  void GetExecSummary( ::impala::TExecSummary& _return, const  ::beeswax::QueryHandle& handle) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetExecSummary(_return, handle);
    }
    ifaces_[i]->GetExecSummary(_return, handle);
    return;
  }
